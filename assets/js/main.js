// ================================================
//  HINBORG INFRASTRUCTURE GROUP — main.js
// ================================================
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form?.addEventListener('submit', async (e) => {
    ...
    if (!messageEl?.value.trim()) {
      showError(messageEl, 'Please describe your project or inquiry.');
      valid = false;
    }
    if (!valid) return;
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (successBox) {
          ...
          window.scrollTo({
            top: successBox.getBoundingClientRect().top + window.scrollY - 120,
            behavior: 'smooth'
          });
        }
      } else {
